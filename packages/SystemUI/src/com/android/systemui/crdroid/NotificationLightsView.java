...
public class NotificationLightsView extends RelativeLayout {
    ...
    public int getNotificationLightsColor() {
        ...
        boolean useAccent = Settings.Secure.getIntForUser(mContext.getContentResolver(),
                Settings.Secure.NOTIFICATION_PULSE_ACCENT,
    ...
    public int getDefaultNotificationLightsColor() {
        ...
        return Settings.Secure.getIntForUser(mContext.getContentResolver(),
                    Settings.Secure.NOTIFICATION_PULSE_COLOR, defaultColor,
